...
class Olympus_Google_Fonts {
	...
	public function includes() {
		...
		include OGF_DIR_PATH . 'includes/class-ogf-google-url.php';
	...
	public function enqueue() {
		...
		if ( $url->has_custom_fonts() ) {
			wp_enqueue_style( 'olympus-google-fonts', $url->build(), '', OGF_VERSION );
		}
	...
	public function customize_controls_enqueue() {
		...
		wp_enqueue_style( 'ogf-customize-controls', esc_url( OGF_DIR_URL . 'assets/css/customize-controls.css' ), '', OGF_VERSION );
