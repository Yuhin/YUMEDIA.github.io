...
<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
	...
	<div class="panel panel-default">
		<div class="panel-heading panel-heading-theme-1 icon-right" role="tab" id="heading1" data-toggle="collapse" data-parent="#accordion" href="#collapse1" aria-controls="collapse1">
			<h4 class="panel-title">
				<a data-toggle="collapse" data-parent="#accordion" href="#collapse1" aria-expanded="true" aria-controls="collapse1"><i class="fa fa-chevron-down"></i>
				  <?php _e('A. Columns & Thumbnail Settings', VGP_TXTDM); ?>
				</a>
			</h4>
		</div>
		<div id="collapse1" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading1">
			<div class="panel-body">
				...
				<p class="">
					<p class="bg-title"><?php _e('1. Gallery Thumbnail Size', VGP_TXTDM); ?></p></br>
				...
				<p class="">
					<p class="bg-title"><?php _e('2. Colums On Large Desktops', VGP_TXTDM); ?></p>
				...
				<p class="">
					<p class="bg-title"><?php _e('3. Colums On Desktops', VGP_TXTDM); ?></p>
				...
				<p class="">
					<p class="bg-title"><?php _e('4. Colums On Tablets', VGP_TXTDM); ?></p>
				...
				<p class="">
					<p class="bg-title"><?php _e('5. Colums On Phones', VGP_TXTDM); ?></p>
		...
		<div class="panel-heading panel-heading-theme-1 icon-right" role="tab" id="heading2" data-toggle="collapse" data-parent="#accordion" href="#collapse2" aria-controls="collapse2">
			<h4 class="panel-title">
				<a data-toggle="collapse" data-parent="#accordion" href="#collapse2" aria-expanded="true" aria-controls="collapse2"><i class="fa fa-chevron-down"></i>
				  <?php _e('B. Width & Height Settings', VGP_TXTDM); ?>
				</a>
			</h4>
		</div>
		<div id="collapse2" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading2">
			<div class="panel-body">
				<p class="video-settings">
					<p class="bg-title"><?php _e('1. Width', VGP_TXTDM); ?></p>
				...
				<p class="video-settings">
					<p class="bg-title"><?php _e('2. Height', VGP_TXTDM); ?></p>
	...
	<div class="panel panel-default">
		<div class="panel-heading panel-heading-theme-1 icon-right" role="tab" id="heading3" data-toggle="collapse" data-parent="#accordion" href="#collapse3" aria-controls="collapse2">
			<h4 class="panel-title">
				<a data-toggle="collapse" data-parent="#accordion" href="#collapse3" aria-expanded="true" aria-controls="collapse3"><i class="fa fa-chevron-down"></i>
				  <?php _e('C. Auto play/Close Settings', VGP_TXTDM); ?>
				</a>
			</h4>
		</div>
		<div id="collapse3" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading3">
			<div class="panel-body">
				<p class="video-settings">
					<p class="bg-title"><?php _e('1. Auto Play', VGP_TXTDM); ?></p>
				...
				<p class="video-settings">
					<p class="bg-title"><?php _e('2. Auto Close', VGP_TXTDM); ?></p>
					<p class="switch-field em_size_field">
		...
		<div class="panel-heading panel-heading-theme-1 icon-right" role="tab" id="heading9" data-toggle="collapse" data-parent="#accordion" href="#collapse10" aria-controls="collapse10">
			<h4 class="panel-title">
				<a data-toggle="collapse" data-parent="#accordion" href="#collapse10" aria-expanded="true" aria-controls="collapse10"><i class="fa fa-chevron-down"></i>
				  <?php _e('D. Extra Other Settings', VGP_TXTDM); ?>
				</a>
			</h4>
		</div>
		<div id="collapse10" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading9">
			<div class="panel-body">		
				<p class="range-slider">
					<p class="bg-title"><?php _e('1. Z index', VGP_TXTDM); ?></p>
					<p class="switch-field em_size_field">
						<?php 
				...
				<p class="video-settings">
					<p class="bg-title"><?php _e('2. Custom CSS', VGP_TXTDM); ?></p>
	...
	<div class="panel panel-default">
		<div class="panel-heading panel-heading-theme-1 icon-right" role="tab" id="heading11" data-toggle="collapse" data-parent="#accordion" href="#collapse11" aria-controls="collapse11">
			<h4 class="panel-title">
				<a data-toggle="collapse" data-parent="#accordion" href="#collapse11" aria-expanded="true" aria-controls="collapse11"><i class="fa fa-chevron-down"></i>
					<?php _e('E. Fade In/Out Settings', VGP_TXTDM); ?>
				</a>
			</h4>
		</div>
		<div id="collapse11" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading11">
			<div class="panel-body">	
				<p class="bg-title"><?php _e('1. Fade In', VGP_TXTDM); ?></p>	
				<p class="">&nbsp;&nbsp;
					<a href="https://awplife.com/account/signup/video-gallery-premium" target="_blank" class="button button-primary  load-customize hide-if-no-customize"><?php _e('Upgrade To Pro', VGP_TXTDM); ?></a>
				</p>
				<p class="bg-title"><?php _e('2. Fade Out', VGP_TXTDM); ?></p>	
				<p class="">&nbsp;&nbsp;
					<a href="https://awplife.com/account/signup/video-gallery-premium" target="_blank" class="button button-primary  load-customize hide-if-no-customize"><?php _e('Upgrade To Pro', VGP_TXTDM); ?></a>
				</p>
			</div>
	...
	<!-- Glow Settings -->
	<div class="panel panel-default">
		<div class="panel-heading panel-heading-theme-1 icon-right" role="tab" id="heading12" data-toggle="collapse" data-parent="#accordion" href="#collapse12" aria-controls="collapse12">
			<h4 class="panel-title">
				<a data-toggle="collapse" data-parent="#accordion" href="#collapse12" aria-expanded="true" aria-controls="collapse12"><i class="fa fa-chevron-down"></i>
					<?php _e('F. Glow Settings', VGP_TXTDM); ?>
				</a>
			</h4>
		</div>
		<div id="collapse12" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading12">
			<div class="panel-body">	
				<p class="bg-title"><?php _e('1. Glow Radius', VGP_TXTDM); ?></p>	
				<p class="">&nbsp;&nbsp;
					<a href="https://awplife.com/account/signup/video-gallery-premium" target="_blank" class="button button-primary  load-customize hide-if-no-customize"><?php _e('Upgrade To Pro', VGP_TXTDM); ?></a>
				</p>
				<p class="bg-title"><?php _e('2. Glow Color', VGP_TXTDM); ?></p>	
				<p class="">&nbsp;&nbsp;
					<a href="https://awplife.com/account/signup/video-gallery-premium" target="_blank" class="button button-primary  load-customize hide-if-no-customize"><?php _e('Upgrade To Pro', VGP_TXTDM); ?></a>
				</p>
			</div>
	...
	<!-- Color Settings -->
	<div class="panel panel-default">
		<div class="panel-heading panel-heading-theme-1 icon-right" role="tab" id="heading13" data-toggle="collapse" data-parent="#accordion" href="#collapse13" aria-controls="collapse13">
			<h4 class="panel-title">
				<a data-toggle="collapse" data-parent="#accordion" href="#collapse13" aria-expanded="true" aria-controls="collapse13"><i class="fa fa-chevron-down"></i>
					<?php _e('G. Color Settings', VGP_TXTDM); ?>
				</a>
			</h4>
		</div>
		<div id="collapse13" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading13">
			<div class="panel-body">
				<p class="bg-title"><?php _e('1. Background Color', VGP_TXTDM); ?></p>	
				<p class="">&nbsp;&nbsp;
					<a href="https://awplife.com/account/signup/video-gallery-premium" target="_blank" class="button button-primary  load-customize hide-if-no-customize"><?php _e('Upgrade To Pro', VGP_TXTDM); ?></a>
				</p>
				<p class="bg-title"><?php _e('2. Background Color Opicity', VGP_TXTDM); ?></p>	
				<p class="">&nbsp;&nbsp;
					<a href="https://awplife.com/account/signup/video-gallery-premium" target="_blank" class="button button-primary  load-customize hide-if-no-customize"><?php _e('Upgrade To Pro', VGP_TXTDM); ?></a>
				</p>
				<p class="bg-title"><?php _e('3. Video Frame Color', VGP_TXTDM); ?></p>	
				<p class="">&nbsp;&nbsp;
					<a href="https://awplife.com/account/signup/video-gallery-premium" target="_blank" class="button button-primary  load-customize hide-if-no-customize"><?php _e('Upgrade To Pro', VGP_TXTDM); ?></a>
				</p>
				<p class="bg-title"><?php _e('4. Video Frame Border', VGP_TXTDM); ?></p>	
				<p class="">&nbsp;&nbsp;
					<a href="https://awplife.com/account/signup/video-gallery-premium" target="_blank" class="button button-primary  load-customize hide-if-no-customize"><?php _e('Upgrade To Pro', VGP_TXTDM); ?></a>
				</p>
			</div>
	...
	<!-- Color Settings -->
	<div class="panel panel-default">
		<div class="panel-heading panel-heading-theme-1 icon-right" role="tab" id="heading14" data-toggle="collapse" data-parent="#accordion" href="#collapse14" aria-controls="collapse14">
			<h4 class="panel-title">
				<a data-toggle="collapse" data-parent="#accordion" href="#collapse14" aria-expanded="true" aria-controls="collapse14"><i class="fa fa-chevron-down"></i>
					<?php _e('H. Load More Settings', VGP_TXTDM); ?>
				</a>
			</h4>
		</div>
		<div id="collapse14" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading14">
			<div class="panel-body">
				<p class="bg-title"><?php _e('1. Set Load More On Video Gallery', VGP_TXTDM); ?></p>
				<p class="">&nbsp;&nbsp;
					<a href="https://awplife.com/account/signup/video-gallery-premium" target="_blank" class="button button-primary  load-customize hide-if-no-customize"><?php _e('Upgrade To Pro', VGP_TXTDM); ?></a>
				</p>
			</div>
...
<hr><br><br>
	<p class="">&nbsp;&nbsp;
		<a href="https://awplife.com/account/signup/video-gallery-premium" target="_blank" class="button button-primary button-hero load-customize hide-if-no-customize">Buy Premium Version</a>
		...
		<a href="https://awplife.com/demo/video-gallery-premium-admin-demo/" target="_blank" class="button button-primary button-hero load-customize hide-if-no-customize">Try Admin Demo</a>
	</p>
	<hr>
	<style>
		.awp_bale_offer {
