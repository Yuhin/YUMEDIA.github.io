...
<form method="POST" oninput="TotalSoft_VGallery_Out()">
	...
	<table class="Total_Soft_AMOTable">
		...
		<tr>
			...
			<td><a href="http://total-soft.pe.hu/wp-effective-video-gallery-1/" target="_blank" class="TS_GV_Free_Link"><i class="Total_Soft_icon totalsoft totalsoft-eye"></i></a></td>
		...
		<tr>
			...
			<td>Effective Gallery</td>
			<td><a href="http://total-soft.pe.hu/wp-effective-video-gallery-2/" target="_blank" class="TS_GV_Free_Link"><i class="Total_Soft_icon totalsoft totalsoft-eye"></i></a></td>
			<td onclick="Total_Soft_Gallery_Video_Opt_AMD2_But1()"><i class="Total_Soft_icon totalsoft totalsoft-file-text"></i></td>
			<td onclick="Total_Soft_Gallery_Video_Opt_AMD2_But1()"><i class="Total_Soft_icon totalsoft totalsoft-pencil"></i></td>
			<td onclick="Total_Soft_Gallery_Video_Opt_AMD2_But1()"><i class="Total_Soft_icon totalsoft totalsoft-trash"></i></td>
		</tr>
		<tr>
			...
			<td>Gallery Album</td>
			<td><a href="http://total-soft.pe.hu/wp-album-video-gallery-1/" target="_blank" class="TS_GV_Free_Link"><i class="Total_Soft_icon totalsoft totalsoft-eye"></i></a></td>
			<td onclick="Total_Soft_Gallery_Video_Opt_AMD2_But1()"><i class="Total_Soft_icon totalsoft totalsoft-file-text"></i></td>
			<td onclick="Total_Soft_Gallery_Video_Opt_AMD2_But1()"><i class="Total_Soft_icon totalsoft totalsoft-pencil"></i></td>
			<td onclick="Total_Soft_Gallery_Video_Opt_AMD2_But1()"><i class="Total_Soft_icon totalsoft totalsoft-trash"></i></td>
		</tr>
		<tr>
			...
			<td>Gallery Album</td>
			<td><a href="http://total-soft.pe.hu/wp-album-video-gallery-2/" target="_blank" class="TS_GV_Free_Link"><i class="Total_Soft_icon totalsoft totalsoft-eye"></i></a></td>
			<td onclick="Total_Soft_Gallery_Video_Opt_AMD2_But1()"><i class="Total_Soft_icon totalsoft totalsoft-file-text"></i></td>
			<td onclick="Total_Soft_Gallery_Video_Opt_AMD2_But1()"><i class="Total_Soft_icon totalsoft totalsoft-pencil"></i></td>
			<td onclick="Total_Soft_Gallery_Video_Opt_AMD2_But1()"><i class="Total_Soft_icon totalsoft totalsoft-trash"></i></td>
		</tr>
		...
		<div class="Total_Soft_AMSetDiv_Content">
			...
			<div class="TS_GV_Option_Div TS_GV_Option_Divv" id="Total_Soft_AMSetTable_2_PO">
				...
				<div class="TS_GV_Option_Divv2">
					...
					<div class="TS_GV_Option_Div1">
						<div class="TS_GV_Option_Name">Type <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="You can select icons from a variety of beautifully designed sets for the lightbox."></i></div>
						<div class="TS_GV_Option_Field">
							<select class="Total_Soft_Select" name="" id="TotalSoft_GV_LG_19" style="font-family: 'FontAwesome', Arial;">
								<option value='1'> <?php echo '&#xf144' . '&nbsp; &nbsp;' . 'Play Circle';?>   </option>
								<option value='2'> <?php echo '&#xf01d' . '&nbsp; &nbsp;' . 'Play Circle O';?> </option>
								<option value='3'> <?php echo '&#xf04b' . '&nbsp; &nbsp;' . 'Play';?>          </option>
							</select>
						</div>
					</div>
					<div class="TS_GV_Option_Div1">
					...
					<div class="TS_GV_Option_Div1 Total_Soft_Titles Total_Soft_Titles1">Close Icon Option</div>
					<div class="TS_GV_Option_Div1">
						<div class="TS_GV_Option_Name">Type <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="You can choose icons from different beautifully designed sets in video to close the lightbox."></i></div>
						<div class="TS_GV_Option_Field">
							<select class="Total_Soft_Select" name="" id="TotalSoft_GV_LG_24" style="font-family: 'FontAwesome', Arial;">
								<option value='1'> <?php echo '&#xf00d' . '&nbsp; &nbsp;' . 'Times';?>          </option>
								<option value='2'> <?php echo '&#xf05c' . '&nbsp; &nbsp;' . 'Times Circle O';?> </option>
								<option value='3'> <?php echo '&#xf057' . '&nbsp; &nbsp;' . 'Times Circle';?>   </option>
							</select>
	...
	<div class="Total_Soft_AMSetDiv" id="Total_Soft_AMSetDiv_3">
		...
		<div class="Total_Soft_AMSetDiv_Content">
			<div class="TS_GV_Option_Div" id="Total_Soft_AMSetTable_3_GO">
				...
				<div class="TS_GV_Option_Div1">
					<div class="TS_GV_Option_Name">Animation Speed <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="The animation time function specifies the speed of an animation."></i></div>
					<div class="TS_GV_Option_Field">
				...
				<div class="TS_GV_Option_Div1">
					<div class="TS_GV_Option_Name">Fill Color <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="The fill property in CSS is for filling in the color of a shape."></i></div>
					<div class="TS_GV_Option_Field">
						<input type="text" name="TotalSoft_GV_TV_04" id="TotalSoft_GV_TV_04" class="Total_Soft_VGallery_Color" value="">
					</div>
				</div>
				<div class="TS_GV_Option_Div1">
					<div class="TS_GV_Option_Name">Slices <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="The slice effect creates a beautiful look in a slideshow and has become quite popular."></i></div>
					<div class="TS_GV_Option_Field">
				...
				<div class="TS_GV_Option_Div1">
					<div class="TS_GV_Option_Name">Box Cols <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Specify the number of box cols which will be shown."></i></div>
					<div class="TS_GV_Option_Field">
				...
				<div class="TS_GV_Option_Div1">
					<div class="TS_GV_Option_Name">Box Rows <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Specify the number of box rows which will be shown."></i></div>
					<div class="TS_GV_Option_Field">
				...
				<div class="TS_GV_Option_Div1">
					<div class="TS_GV_Option_Name">PopOut Margin <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select image zoom size in Popout hover effect."></i></div>
					<div class="TS_GV_Option_Field">
				...
				<div class="TS_GV_Option_Div1">
					<div class="TS_GV_Option_Name">PopOut Shadow <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select size which allows to show the shadow of the image in Popout hover effect."></i></div>
					<div class="TS_GV_Option_Field">
				...
				<div class="TS_GV_Option_Div1">
					<div class="TS_GV_Option_Name">Shadow Color <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Select color which allows to show the shadow of the image in Popout hover effect."></i></div>
					<div class="TS_GV_Option_Field">
		...
		<div class="Total_Soft_AMSetDiv_Content">
			...
			<div class="TS_GV_Option_Div TS_GV_Option_Divv" id="Total_Soft_AMSetTable_5_PO">
				<div class="TS_GV_Option_Divv1">
					<div class="TS_GV_Option_Div1 Total_Soft_Titles">Popup Options</div>
					<div class="TS_GV_Option_Div1">
						<div class="TS_GV_Option_Name">Overlay Background Color <span class="TS_Free_version_Span"> (Pro)</span> <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="Choose a background color for the overlay."></i></div>
						<div class="TS_GV_Option_Field">
