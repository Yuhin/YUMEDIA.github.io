	...
	class Total_Soft_Gallery_Video extends WP_Widget
	{
		...
		function widget($args,$instance)
		{
			...
			if($Total_Soft_GalleryV_Type[0]->TotalSoftGalleryV_SetType=='Grid Video Gallery'){ ?>
				...
				<div class="container_1<?php echo $Total_Soft_Gallery_Video;?> container_1" style="position: relative; float: left; display: block; width: 100%;">
				...
				<script>
					...
					function Total_Soft_GV_GVG_PagePresp<?php echo $Total_Soft_Gallery_Video; ?>(){
						...
						for(i=0;i<=countFGTotalSoft<?php echo $Total_Soft_Gallery_Video; ?>-1;i++)
						{
							...
							else if(jQuery('.slideshow<?php echo $Total_Soft_Gallery_Video; ?> ul li').eq(i).hasClass('iframecontainer'))
							{
							...
							else if(jQuery('.slideshow<?php echo $Total_Soft_Gallery_Video; ?> ul li').eq(i).hasClass('imagecontainer'))
							{
								jQuery('.slideshow<?php echo $Total_Soft_Gallery_Video; ?> ul li').eq(i).css('height',jQuery('.slideshow<?php echo $Total_Soft_Gallery_Video; ?> ul li').eq(i).find('figcaption').height()+jQuery('.slideshow<?php echo $Total_Soft_Gallery_Video; ?> ul li').eq(i).find('img').height()+70);
							}
				...
				<script type="text/javascript">
					...
					{
						jQuery("html, body").animate({ scrollTop: jQuery('.container_1'+TotalSoftGV_ID).position().top - 10 }, 1000);
						var delaytime = 0;
					...
					<div class="totalsoft-gv-lvg-content<?php echo $Total_Soft_Gallery_Video; ?>">
						<ul class="ulContWidth totalsoft-gv-lvg-area<?php echo $Total_Soft_Gallery_Video; ?>" style='padding:0px;'>
							<?php for($i=0;$i<count($Total_Soft_GalleryV_Videos);$i++){ ?>
								...
								else{ $TS_GV_LVG_VSR = $Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_Video; }?>
								<?php if($Total_Soft_GalleryV_Man[0]->TotalSoftGallery_Video_ShowType=='All'){ ?>
									<li class="totalsoft-gv-lvg-item2 TotalSoft_GV_LVG_Li" id="TotalSoft_GV_LVG_<?php echo $Total_Soft_Gallery_Video;?>_<?php echo $i+1;?>" style='max-width:100%;'>
										<div class='fHeightZoom<?php echo $Total_Soft_Gallery_Video; ?>'>
											<span class="totalsoft-gv-lvg-image-block<?php echo $Total_Soft_Gallery_Video; ?>"> 
												<a class="image-zoom" href="<?php echo $TS_GV_LVG_VSR;?>" rel="prettyPhoto[gallery_<?php echo $Total_Soft_Gallery_Video; ?>]" title="<?php if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_14=='true'){ echo html_entity_decode($Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VT);} ?>">
			...
			<?php } else if($Total_Soft_GalleryV_Type[0]->TotalSoftGalleryV_SetType=='Elastic Gallery') { ?>
				...
				<div class="video-gallery-parent<?php echo $Total_Soft_Gallery_Video;?>" style="position: relative; width: 100%; float: left;">
					...
					<div id="video-gallery" class='Tot_Vid_Gallery<?php echo $Total_Soft_Gallery_Video;?>' style='text-align:center;'>
						<?php for($i=0;$i<count($Total_Soft_GalleryV_Videos);$i++){ ?>
							...
							<?php if($Total_Soft_GalleryV_Man[0]->TotalSoftGallery_Video_ShowType=='All'){ ?>
							<div id="TotalSoft_GV_HLG_<?php echo $Total_Soft_Gallery_Video;?>_<?php echo $i+1;?>" class='fhovZoom<?php echo $Total_Soft_Gallery_Video;?>' href="<?php echo $TS_GV_EG_VSR;?>" data-poster="<?php echo $TS_GV_EG_PSR;?>" onclick='TotalsofthPIcon()'>
								<a href='#'>
							...
							<?php }else{ ?>
								...
								<?php }else{ ?>
									<div style='display:none;' id="TotalSoft_GV_HLG_<?php echo $Total_Soft_Gallery_Video;?>_<?php echo $i+1;?>" class='fhovZoom<?php echo $Total_Soft_Gallery_Video;?> noshow1' href="<?php echo $TS_GV_EG_VSR;?>" data-poster="<?php echo $TS_GV_EG_PSR;?>" onclick='TotalsofthPIcon()'>
										<a href='#'>
											<img class='zEff <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_08;?>' style='max-width:none;' src="<?php echo $Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_IURL;?>" />
											<div class='<?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_14;?>' style='background:<?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_13;?>;'> 
												<span style='margin-left:5px; font-size: <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_10;?>px; color:<?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_11;?>; font-family: <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_12;?>; display:<?php echo $TotalSoft_GV_1_16;?>'>
						...
						<?php for($i=0;$i<count($Total_Soft_GalleryV_Videos);$i++){ ?>
							...
							<?php if($Total_Soft_GalleryV_Man[0]->TotalSoftGallery_Video_ShowType=='All'){ ?>
								<?php if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_29==1) { ?>
									<a id="TotalSoft_GV_PE_<?php echo $Total_Soft_Gallery_Video;?>_<?php echo $i+1;?>" class="TotalSoft_H_Ef<?php echo $Total_Soft_Gallery_Video;?> <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_07; ?> swipebox<?php echo $Total_Soft_Gallery_Video;?>-video-TotSoft<?php echo $Total_Soft_Gallery_Video; ?>" href="<?php echo $TS_GV_PE_VSR;?>" name="<?php echo html_entity_decode($Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VT);?>">
							...
							<?php }else{ ?>
								...
								<?php }else{ ?>
									<?php if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_29==1) { ?>
										<a id="TotalSoft_GV_PE_<?php echo $Total_Soft_Gallery_Video;?>_<?php echo $i+1;?>" style="display:none;" class="noshow1 TotalSoft_H_Ef<?php echo $Total_Soft_Gallery_Video;?> <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_07; ?> swipebox<?php echo $Total_Soft_Gallery_Video;?>-video-TotSoft<?php echo $Total_Soft_Gallery_Video; ?>" href="<?php echo $TS_GV_PE_VSR;?>" name="<?php echo html_entity_decode($Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VT);?>">
											<img class="TotalSoft_HZ2" alt="<?php echo html_entity_decode($Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VT);?>" src="<?php echo $Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_IURL;?>" />
											<span style="display:inline-block;" class="TotalSoft_Title_Ef <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_14; ?>">
												<?php echo html_entity_decode($Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VT);?>
												<?php if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_15==1 || $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_15=='true') { ?>
