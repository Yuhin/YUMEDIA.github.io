			...
			<table class="TS_GV_Add_Video_Table">
				...
				<tr>
					...
					<td>
						...
						<input type="text" name="TotalSoftGallery_Video_Title" id="TotalSoftGallery_Video_Title" class="Total_Soft_Select" placeholder=" * Required" style="margin-right: 21px;">
					</td>
				</tr>
				<tr>
					<td>
