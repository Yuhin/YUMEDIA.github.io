 ...
 */
function h5vp_yourprefix_show_if_front_page( $cmb ) {
 ...
 * @return bool                     True if metabox should show
 */
function h5vp_yourprefix_hide_if_no_cats( $field ) {
 ...
 * @param  CMB2_Field object $field      Field object
 */
function h5vp_yourprefix_before_row_if_2( $field_args, $field ) {
...
add_action( 'cmb2_admin_init', 'h5vp_yourprefix_register_demo_metabox' );
/**
 * Hook in and add a demo metabox. Can only happen on the 'cmb2_admin_init' or 'cmb2_init' hook.
 */
function h5vp_yourprefix_register_demo_metabox() {
...
add_action( 'cmb2_admin_init', 'h5vp_yourprefix_register_repeatable_group_field_metabox' );
/**
 * Hook in and add a metabox to demonstrate repeatable grouped fields
 */
function h5vp_yourprefix_register_repeatable_group_field_metabox() {
...
add_action( 'cmb2_admin_init', 'h5vp_yourprefix_register_user_profile_metabox' );
/**
 * Hook in and add a metabox to add fields to the user profile pages
 */
function h5vp_yourprefix_register_user_profile_metabox() {
...
add_action( 'cmb2_admin_init', 'h5vp_yourprefix_register_theme_options_metabox' );
/**
 * Hook in and register a metabox to handle a theme options page
 */
function h5vp_yourprefix_register_theme_options_metabox() {
