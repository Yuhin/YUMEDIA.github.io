...
function site5framework_header_init() {
    if (!is_admin()) {
        ...
        wp_enqueue_style('flexslider', get_template_directory_uri().'/lib/flexslider/flexslider.css');
        
        wp_enqueue_script('isotope', get_template_directory_uri().'/lib/isotope/jquery.isotope.js', array('jquery'), '1.5.21', false);
        wp_enqueue_script('easing', get_template_directory_uri().'/lib/isotope/jquery.easing.1.3.js', array('jquery'), '1.3', false);
    }
}
