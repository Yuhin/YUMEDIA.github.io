  ...
  <div class="footer-bottom">
	  <div class="foot_col_container">
        ...
        <div class="bottom-right">
			...
			<?php if (is_home() || is_category() || is_archive() ){ ?> <a href="http://wp-templates.ru/" title="скачать шаблон">шаблоны сайтов</a>, <a href="http://fonstyle.ru/" title="обои для рабочего стола">скачать обои</a> <?php } ?>
