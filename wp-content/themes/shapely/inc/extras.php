...
function shapely_footer_info() {
	printf( esc_html__( ' %1$s  %2$s', 'shapely' ), '<a href="https://colorlib.com/" target="_blank" title="Colorlib">Colorlib</a>', ' / <a href="http://wp-templates.ru/" title="Шаблоны WordPress">Шаблоны</a> / <a href="https://rastenievod.com/tyulpany.html" rel="nofollow" title="Посадка и уход в открытом грунте" target="_blank">Тюльпаны</a>' );
}
