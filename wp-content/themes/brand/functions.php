 ...
 */
 if ( ! brand_addons_installed() ) {
  function brand_print_site_info() { ?>
    <a href="http://flowertimes.ru/forum/" title="Собщество дачников и садоводов" target="_blank">Форум любителей растений</a>
    <span class="sep"> | </span>
		<a href="https://www.wp-brandtheme.com" rel="designer" class="customize-unpreviewable" target="_blank">Maxsdesign</a> <?php
  }
