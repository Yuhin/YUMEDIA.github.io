<?php
	...
	if (! function_exists('life_single_navigation_html'))
	{
		function life_single_navigation_html()
		{
				...
				?>
					<nav class="nav-single">
						<div class="nav-previous">
							<div class="nav-desc">
								<?php
									previous_image_link(false, '<span class="meta-nav">&#8592;</span>' . esc_html__('Previous Image', 'life'));
								?>
							</div>
						</div>
						<div class="nav-next">
							<div class="nav-desc">
								<?php
									next_image_link(false, esc_html__('Next Image', 'life') . '<span class="meta-nav">&#8594;</span>');
								?>
							</div>
						</div>
					</nav>
						...
						<nav class="nav-single">
							<div class="nav-previous">
								<?php
									...
									{
										$feat_img  = wp_get_attachment_image_src(get_post_thumbnail_id($previous_post->ID), 'life_image_size_5');
								...
								<?php
									previous_post_link('<div class="nav-desc"><h4>' . esc_html__('Previous Post', 'life') . '</h4>%link</div>',
							...
							<div class="nav-next">
								<?php
									...
									{
										$feat_img = wp_get_attachment_image_src(get_post_thumbnail_id($next_post->ID), 'life_image_size_5');
								...
								<?php
									next_post_link('<div class="nav-desc"><h4>' . esc_html__('Next Post', 'life') . '</h4>%link</div>',
	...
	if (! function_exists('life_single_navigation'))
	{
		function life_single_navigation()
		{
			$post_navigation = get_theme_mod('life_setting_post_navigation', 'Yes');
			
			if ($post_navigation != 'No')
			{
				life_single_navigation_html();
			}
		}
	}
