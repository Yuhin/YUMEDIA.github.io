			...
			<div class="row">
				...
				<div class="<?php echo sanitize_html_class( $copyright_class ); ?>">
					<h1 class="logo">
						...
						<p><?php printf( esc_html__( '%1$s &copy; %2$s' ), esc_html( get_bloginfo( 'name' ) ), esc_html( date( 'Y' ) ) ); ?></p>
						<p><a href="http://slicejack.com" rel="designer" target="_blank">Slicejack</a> | <a href="https://feedup.ru" target="_blank">feedup.ru</a></p>
					</h1><!-- /.logo -->
				</div><!-- /.col -->
