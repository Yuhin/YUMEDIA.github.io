           ...
           <div class="content gray-bg">   
              <div class="container-fluid">
                  <div class="other-portfolio clearfix">
                      ...
                      { echo  esc_attr ( ot_get_option( 'other_port_sub' )); } else {esc_html_e('See our other portfolio','derwati');} ?></p>
                      
                      <h3 class="op-title"><?php if ( function_exists( 'ot_get_option' )&& ot_get_option( 'other_port_title' ) !='')
                      { echo esc_attr ( ot_get_option( 'other_port_title' )); } else {esc_html_e('Other portfolio','derwati');} ?></h3>
