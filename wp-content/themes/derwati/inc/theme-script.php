...
function derwati_theme_scripts() {
		...
		wp_enqueue_script( 'derwati-animation', get_template_directory_uri() . '/js/slick-animation.js',array(),'', 'in_footer');
		wp_enqueue_script( 'derwati-totop', get_template_directory_uri() . '/js/totop.js',array(),'', 'in_footer');
		wp_enqueue_script( 'derwati-scripts', get_template_directory_uri() . '/js/script.js',array(),'', 'in_footer');
}    
