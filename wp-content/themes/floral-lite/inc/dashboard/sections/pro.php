	...
	<table class="form-table">
		...
		<tbody>
			...
			<tr>
				<td></td>
				<td colspan="2">
					<a href="<?php echo esc_url( "https://gretathemes.com/wordpress-themes/floral/?utm_source=theme_dashboard&utm_medium=buy_link&utm_campaign={$this->theme->template}_dashboard" ); ?>" target="_blank" class="button button-primary button-hero"><?php esc_html_e( 'Get Floral PRO now', 'floral-lite' ); ?></a>
				</td>
			</tr>
		</tbody>
	</table>
