...
function optionsframework_options() {
	...
	//SLIDER SETTINGS
	$options[] = array(
		'name' => __('Homepage Slider', 'panorama-pro'),
		'type' => 'heading');

	$options[] = array(
		'name' => __('Slider Image 1', 'panorama'),
		'desc' => __('First Slide', 'panorama'),
		'id' => 'slide1',
		'class' => '',
	...
	$options[] = array(
		'name' => __('Slider Image 2', 'panorama'),
		'desc' => __('Second Slide', 'panorama'),
		'class' => '',
		'id' => 'slide2',
	...
	$options[] = array(
		'name' => __('Slider Image 3', 'panorama'),
		'desc' => __('Third Slide', 'panorama'),
		'id' => 'slide3',
		'class' => '',
	...
	$options[] = array(
		'name' => __('Slider Image 4', 'panorama'),
		'desc' => __('Fourth Slide', 'panorama'),
		'id' => 'slide4',
		'class' => '',
	...
	$options[] = array(
		'name' => __('Slider Image 5', 'panorama'),
		'desc' => __('Fifth Slide', 'panorama'),
		'id' => 'slide5',
		'class' => '',
	...
	$options[] = array(
	 ...
	 $options[] = array(
		'desc' => '<a href="'.esc_url(SKT_THEME_URL).'" target="_blank"><img src="'.get_template_directory_uri().'/images/sktskill.jpg"></a><p><em><a target="_blank" href="'.esc_url(SKT_THEME_URL_DIRECT).'">'.__('Buy PRO version for only $30 with more features.','panaroma').'</a></em></p>',
		'type' => 'info');	
