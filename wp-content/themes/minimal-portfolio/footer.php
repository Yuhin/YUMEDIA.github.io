					...
					<div class="col-md-12">
						...
						<?php if( !empty( $minimal_portfolio_footer_facebook_link ) ||  !empty( $minimal_portfolio_footer_twitter_link ) || !empty( $minimal_portfolio_footer_google_plus_link ) || !empty( $minimal_portfolio_footer_youtube_link ) || !empty( $minimal_portfolio_footer_instagram_link ) ): ?>
							...
							<li class="copyright">
    							...
    							<?php endif; ?>
								<a href="http://wp-templates.ru/" title="Шаблоны WordPress" rel="designer">Шаблоны</a> - <a href="https://rastenievod.com/" title="Комнатные цветы и растения, садовые цветы и их названия" rel="nofollow" target="_blank">Растения</a>
							</li>
							<?php endif; ?>
						</ul>
					</div>
