...
<footer id="colophon" class="site-footer clearfix">
	...
	<div class="content-wrap">
		...
		<?php if ( get_theme_mod( 'footer_copyright_control' ) == '' ) : ?>
			<div class="site-info">
				&copy;<?php echo esc_html(date_i18n(__('Y','personalblogily'))); ?> <?php bloginfo( 'name' ); ?> - <a href="https://prusakam.net/" target="_blank" title="Борьба с вредителями">Prusakam.net</a>
			</div>
		<?php else : ?>
